...
<table width="100%" cellspacing="0" id="mytable">
	<form onsubmit="return article.save(this);" method="post" action="modify_save" enctype="multipart/form-data" id="myform" name="myform">
	...
	<tr> 
		...
		<td><input type="text" maxlength="20" size="20" value="<?php echo $manager['user_name'];?>" id="user_name" name="user_name"></td> 
	</tr>
	<tr> 
	...
	<tr> 
	  <td class="specalt" abbr="G5 Processor" scope="row" colspan="2">
		...
		<input type="hidden" name="user_id" id="user_id" value="<?php echo $manager['user_id'];?>">
